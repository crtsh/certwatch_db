...
INSERT INTO trust_purpose ( ID, PURPOSE, PURPOSE_OID, DISPLAY_ORDER ) VALUES ( 15, 'Brand Indicator for Message Identification', '1.3.6.1.5.5.7.3.31', 45 );
...
CREATE TABLE ccadb_certificate(
	...
	CP_URL							text,
	CP_EFFECTIVE_DATE				timestamp,
	CPS_SAME_AS_PARENT				boolean,
	CPS_URL							text,
	CPS_EFFECTIVE_DATE				timestamp,
	CP_CPS_SAME_AS_PARENT			boolean,
	CP_CPS_URL						text,
	CP_CPS_EFFECTIVE_DATE			timestamp,
	MD_CP_CPS_SAME_AS_PARENT		boolean,
	MD_CP_CPS_URL					text,
	MD_CP_CPS_EFFECTIVE_DATE		timestamp,
