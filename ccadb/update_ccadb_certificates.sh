...
wget -O ccadb_all_certificate_records.csv.new https://ccadb-public.my.salesforce-sites.com/ccadb/AllCertificateRecordsCSVFormat
RESULT=$?
if [ "$RESULT" -eq "0" ]; then
  ...
  echo "Failed to download https://ccadb-public.my.salesforce-sites.com/ccadb/AllCertificateRecordsCSVFormat"
fi
