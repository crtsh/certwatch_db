CREATE OR REPLACE FUNCTION apple_disclosures(
) RETURNS text
AS $$
DECLARE
	t_undisclosed					text[];
	...
	t_unknown						text[];
BEGIN
	t_undisclosed := ccadb_disclosure_group2(12, 'Undisclosed', 'undisclosed', 'Unconstrained Trust: Disclosure is required!', '#FE838A');
	...
	t_incomplete := ccadb_disclosure_group2(12, 'DisclosureIncomplete', 'disclosureincomplete', 'Certificate disclosed, but CP/CPS, Audit, or CRL details missing or incorrect: Further Disclosure is required!', '#FE838A');
	t_incompleteSummary := ccadb_disclosure_group_summary(12, 'DisclosureIncomplete', 'disclosureincompletesummary', '#FE838A');
	...
	t_incomplete2 := ccadb_disclosure_group2(12, 'CRLDisclosureIncompleteForPossiblyDormantCA', 'disclosureincomplete2', 'Certificate disclosed, but CRL details not disclosed: Further Disclosure might be required', '#FAF884');
	t_incomplete2Summary := ccadb_disclosure_group_summary(12, 'CRLDisclosureIncompleteForPossiblyDormantCA', 'disclosureincomplete2summary', '#FAF884');
	...
	t_revokedButExpired := ccadb_disclosure_group(12, 'RevokedButExpired', 'revokedbutexpired', 'Disclosed as Revoked, but Expired', '#B2CEFE');
	...
	t_disclosedAndUnrevokedFromCRL := ccadb_disclosure_group(12, 'DisclosedButRemovedFromCRL', 'disclosedandunrevokedfromcrl', 'Disclosed (as Not Revoked) and "Unrevoked" from CRL', '#F2A2E8');
	t_disclosed := ccadb_disclosure_group(12, 'Disclosed', 'disclosed', 'Disclosed', '#F2A2E8');
